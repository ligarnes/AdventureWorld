...
import net.alteiar.campaign.view.article.content.ContentViewFactory;
...
public class ArticleView extends Controller {
	...
	public Node getView() {
		...
		for (ContentBO section : getArticle().getContent()) {
			...
			Controller contentView = ContentViewFactory.createContentView(this, section);
			vbox.getChildren().add(contentView.getView());
		}
