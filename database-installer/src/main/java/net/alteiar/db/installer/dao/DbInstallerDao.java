...
public class DbInstallerDao {
	...
	private static final String CREATE_TABLE = "CREATE TABLE IF NOT EXISTS db_installer "
			+ "(module varchar(120), name varchar(120), description varchar(250), insert_time datetime)";

	private static final String DROP_TABLE = "DROP TABLE db_installer ";
